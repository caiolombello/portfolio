              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleProjectChange(index, "imageUrl", e.target.value)
                    }
                    required
                  />
                </div>
                    ...
                    {project.screenshots.map((screenshot, screenshotIndex) => (
                      ...
                      >
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() =>
                            handleRemoveScreenshot(index, screenshotIndex)
                          }
